  ...
  > {
    ...
    if (thread.innovation.owner && thread.innovation.owner.serviceRoles[0]) {
      followers.push({
        ...
        locked: !thread.innovation.owner.serviceRoles[0].isActive || thread.innovation.owner.status !== UserStatusEnum.ACTIVE,
        isOwner: true,
    ...
    collaboratorUsers.forEach(collaboratorUser => {
      followers.push({
        ...
        locked: !collaboratorUser.serviceRoles[0]?.isActive || collaboratorUser.status !== UserStatusEnum.ACTIVE,
        isOwner: false,
    ...
    followers.push(
      ...thread.followers.map(followerRole => ({
        ...
        locked: !followerRole.isActive || followerRole.user.status !== UserStatusEnum.ACTIVE,
        isOwner: false,
        userRole: {
          id: followerRole.id,
